...
FusionGridService.ɵfac = function FusionGridService_Factory(t) { return new (t || FusionGridService)(); };
FusionGridService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: FusionGridService, factory: FusionGridService.ɵfac });
FusionGridService._fgRoot = null;
FusionGridService.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FusionGridService, [{
        type: Injectable
...
FusionGridComponent.ɵfac = function FusionGridComponent_Factory(t) { return new (t || FusionGridComponent)(ɵngcc0.ɵɵdirectiveInject(FusionGridService)); };
FusionGridComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: FusionGridComponent, selectors: [["fusion-grid"]], viewQuery: function FusionGridComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 5);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.gridContainer = _t.first);
    } }, hostAttrs: [1, "fusion-grid-container"], inputs: { gridConfig: "gridConfig", dataTable: "dataTable" }, outputs: { initialized: "initialized", beforeRender: "beforeRender", rendered: "rendered", updated: "updated", resized: "resized", disposed: "disposed", rowHovered: "rowHovered", columnHovered: "columnHovered", rowDoubleClicked: "rowDoubleClicked", headerClicked: "headerClicked", cardClicked: "cardClicked", cardDoubleClicked: "cardDoubleClicked", recordClicked: "recordClicked", recordDoubleClicked: "recordDoubleClicked" }, decls: 2, vars: 0, consts: [[2, "width", "100%", "height", "100%"], ["gridContainer", ""]], template: function FusionGridComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", 0, 1);
    } }, styles: [".fusion-grid-container{ display: block; }"], encapsulation: 2 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FusionGridComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: FusionGridService }]; }, { initialized: [{
            type: Output
        }], beforeRender: [{
            type: Output
        }], rendered: [{
...
FusionGridModule.ɵfac = function FusionGridModule_Factory(t) { return new (t || FusionGridModule)(); };
FusionGridModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: FusionGridModule });
FusionGridModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [FusionGridService], imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FusionGridModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    FusionGridComponent,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(FusionGridModule, { declarations: [FusionGridComponent], exports: [FusionGridComponent] }); })();
